...
class GradhubService:
    ...
    def add_cert(
        self, user_id: int, name: str, provider: str, target_date: str, status: str
    ) -> str:
    ...
    async def github_review(self, profile_text: str, target_role: str) -> dict:
        prompt = PromptManager.load(
            "gradhub/github_review", profile_text=profile_text, target_role=target_role
        )
        ...
        try:
            ...
            return {
                ...
                "strengths": [
                    ...
                    "Solid Javascript projects",
                ],
                "weaknesses": [
                    "Lack of backend systems documentation",
                    "No readme files in 3 main repos",
                ],
                "readme_advice": "Add detailed setup guides, architecture diagrams, and links to live demos for your pinned repos.",
                "project_ideas": [
                    "Building a microservices auth gateway",
                    "Implementing a custom rate-limiting middleware",
                ],
            }

    async def linkedin_optimize(self, profile_text: str, target_role: str) -> dict:
        prompt = PromptManager.load(
            "gradhub/linkedin_optimize",
        ...
        try:
            ...
            return {
                "headline_suggestions": [
                    f"{target_role} | Scaling Web Apps",
                    f"Incoming {target_role} | Open-Source Enthusiast",
                ],
                "about_summary": "Passionate developer focused on building scalable, performant architectures...",
                "star_bullets": [
                    "Designed and implemented a distributed queue system reducing latency by 35%.",
                    "Led development of a React dashboard resulting in 50% faster onboarding.",
                ],
                "keyword_boosters": [
                    "Distributed Systems",
                    "Cloud Architecture",
