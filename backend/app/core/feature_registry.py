...
PUBLIC_FEATURES = [
    ...
    {"id": 23, "key": "sop_essay_feedback", "label": "SOP & Essay AI Reviewer", "group": "Graduate & Higher Ed"},
    {"id": 24, "key": "document_workspaces", "label": "Document & Research Workspaces", "group": "Workspaces"},
    {"id": 25, "key": "rag_document_search", "label": "RAG Multi-Document AI Search", "group": "Workspaces"},
    {"id": 26, "key": "project_showcase", "label": "Project Showcase Builder", "group": "Workspaces"},
    {"id": 27, "key": "career_toolkit", "label": "Career Utilities & Calculators", "group": "Career Toolkit"},
    {"id": 28, "key": "opportunity_submission", "label": "Public Opportunity Signal Submissions", "group": "Ecosystem"},
    {"id": 29, "key": "company_hiring_portal", "label": "Company Hiring Signal Portal", "group": "Ecosystem"},
    {"id": 30, "key": "daily_missions", "label": "Daily Career Missions", "group": "Career Progress"},
    {"id": 31, "key": "career_health", "label": "Career Health & Profile Readiness", "group": "Career Progress"},
]
