...
class WorkingMemoryEngine:
    ...
    def retrieve_and_rank_memories(self, user_id: int, query_context: str, limit: int = 20) -> List[Memory]:
        """
        ...
        for mem in memories:
            ...
            # Days since updated
            age_days = (now - mem.updated_at.replace(tzinfo=timezone.utc)).days if mem.updated_at else 0
    ...
    def assemble_context(self, user_id: int, session_id: str, ui_context: Dict[str, Any], current_message: str) -> Dict[str, Any]:
        """
