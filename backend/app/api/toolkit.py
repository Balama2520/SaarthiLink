...
async def opportunity_feed(current_user: User = Depends(get_current_user)):
    ...
    return [
        {"type": "hackathon", "title": "Smart India Hackathon 2026", "deadline": "2026-09-15", "link": "https://www.sih.gov.in"},
        {"type": "internship", "title": "Google STEP Internship", "deadline": "2026-10-01", "link": "https://careers.google.com"},
        {"type": "fellowship", "title": "MLH Fellowship", "deadline": "2026-09-30", "link": "https://fellowship.mlh.io"},
        {"type": "competition", "title": "ICPC Asia Regional", "deadline": "2026-09-20", "link": "https://icpcasia.org"},
        {"type": "scholarship", "title": "Tata Capital Pankh Scholarship", "deadline": "2026-09-25", "link": "https://tatacapitalpankh.com"},
    ]
...
async def star_bullets(body: STARBody, current_user: User = Depends(get_current_user)):
    return await _run_prompt("career/star_bullets", project_or_exp=body.project_or_exp, description=body.description)
...
async def optimize_keywords(body: KeywordsBody, current_user: User = Depends(get_current_user)):
    return await _run_prompt("career/keywords", resume_text=body.resume_text, job_title=body.job_title)
